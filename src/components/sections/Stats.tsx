    ...
    <section className="relative px-4 pb-16">
      <div className="max-w-4xl mx-auto grid grid-cols-3 gap-4">
        {[
          ...
          <div key={s.label} className={`text-center py-5 rounded-xl bg-black/60 backdrop-blur-xl border border-gold/10 card-hover glow-gold reveal ${['reveal-tilt', 'reveal-zoom', 'reveal-slide-up'][i]} reveal-delay-${i + 1}`}>
