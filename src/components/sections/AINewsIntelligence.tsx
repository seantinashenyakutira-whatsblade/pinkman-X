      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mt-3 mb-4">
            ...
            <span className="bg-gradient-to-r from-gold to-amber bg-clip-text text-transparent">Moves the Market</span>
          </h2>
          ...
          <ul className="space-y-3">
            {['AI-classified high / medium / low impact', 'Currency & asset exposure breakdown', 'Volatility and spread risk windows', 'No automated trading recommendations'].map((item) => (
              <li key={item} className="flex items-start gap-3 text-sm text-muted-light/80">
        ...
        <div>
          <Card className="p-5">
            ...
            <div className="space-y-3">
              {news.map((item) => (
                <div key={item.title} className="flex items-center justify-between py-2 border-b border-border/40 last:border-0">
                  <div>
