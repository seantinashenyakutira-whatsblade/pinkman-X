      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 reveal">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mt-3 mb-4">
            Learn Before You{' '}
            <span className="font-cursive italic font-normal bg-gradient-to-r from-gold to-amber bg-clip-text text-transparent">Automate</span>
          </h2>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {courses.map((c, i) => (
            <Card key={c} className={`p-5 text-center card-hover reveal reveal-delay-${(i % 6) + 1}`}>
