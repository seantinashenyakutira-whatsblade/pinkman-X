    ...
    <section className="relative py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {tools.map((t, i) => (
            <Card key={t.label} className={`p-5 text-center sm:text-left sm:flex sm:items-start sm:gap-4 card-hover reveal reveal-delay-${(i % 6) + 1}`}>
        ...
        <div className="mt-8 text-center reveal reveal-delay-3">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gold/5 border border-gold/15 card-hover">
