...
export default function Chatbot() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-3">
      ...
      {showPopup && (
        <div className="relative animate-fade-in">
          <div className="bg-black/80 backdrop-blur-xl border border-gold/30 rounded-2xl px-4 py-2.5 shadow-[0_0_25px_rgba(212,175,55,0.15)]">
            <button onClick={() => setShowPopup(false)} className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-dark-600 border border-gold/20 flex items-center justify-center hover:bg-dark-700 transition-colors">
      ...
      {/* Chat window */}
      {open && (
        <div className="w-[340px] sm:w-[380px] h-[480px] rounded-2xl bg-black/80 backdrop-blur-xl border border-gold/20 shadow-[0_0_40px_rgba(212,175,55,0.1)] flex flex-col overflow-hidden animate-fade-in">
          ...
          <form onSubmit={handleSend} className="p-3 border-t border-gold/10 shrink-0 flex items-center gap-2">
            <input
              value={input}
      ...
      <button
        ...
        className="w-12 h-12 rounded-full bg-gradient-to-br from-gold to-amber text-dark-950 shadow-[0_0_25px_rgba(212,175,55,0.25)] flex items-center justify-center hover:scale-105 hover:shadow-[0_0_35px_rgba(212,175,55,0.35)] transition-all duration-300"
      >
